...
EXTERNAL_MONITOR="HDMI-A-1"                   # Your external display name
EXTERNAL_RESOLUTION="1920x1080@100"        # External monitor resolution@refresh
LAPTOP_RESOLUTION="1920x1080@60"          # Laptop monitor resolution@refresh
EXTERNAL_SCALE="1"                     # External monitor scaling factor
LAPTOP_SCALE="1.67"                           # Laptop monitor scaling factor
EXTERNAL_POSITION="1920x0"                   # External monitor position
LAPTOP_POSITION_DUAL="0x0"            # Laptop position in dual mode
